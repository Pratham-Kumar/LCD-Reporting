		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "LCD Reporting",
									"targetURL": "#comkpolcdreporting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkpolcdreporting-display": {
								"semanticObject": "comkpolcdreporting",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kpo.lcdreporting",
									"url": sap.ui.require.toUrl("com/kpo/lcdreporting")
								}
							}
						}
					}
